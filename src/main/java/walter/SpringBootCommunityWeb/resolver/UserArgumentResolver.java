package walter.SpringBootCommunityWeb.resolver;
...
import static walter.SpringBootCommunityWeb.domain.eums.SocialType.*;

/**
 * {@link org.springframework.web.method.support.HandlerMethodArgumentResolver}인터페이스 구현
 */
@Component
public class UserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    //검증된 파라미터 정보를 받음
    //이미 검증되어 세션에 저장되어있는 경우를 위해 세션을 먼저 확인하도록 로직 수정
    @Override
